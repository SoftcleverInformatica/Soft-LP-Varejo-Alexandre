...
import HeaderPartial from '../../../public/assets/header.png';
import HeaderFull from '../../../public/assets/HeaderBG.png';
import LogoAzul from '../../../public/assets/logo_azul.svg';
import LogoBranco from '../../../public/assets/logo_branco.svg';
        ...
        col-span-full pl-10 min-w-[20rem] row-span-1 
            ...
            lg:pl-0 lg:col-span-2 lg:col-start-2 lg:row-span-2 lg:row-start-2 flex lg:items-center pt-2'>
				<a className='flex w-full' href='https://softclever.com.br/' target='_blank'>
					<Image className='w-[60%] md:max-h-[4rem] lg:max-h-[3.5rem] lg:w-[100%] lg:ml-[6.5rem]' alt='logo Softclever' src={isMobile ? LogoBranco : LogoAzul} />
				</a>
			</div>
            ...
            lg:text-[#003658] lg:col-span-5 lg:row-span-8 lg:col-start-3 lg:row-start-4'>
				<div className='flex flex-col gap-[18px] mb-5'>
					...
					<h4 className='text-xl font-bold text-justify text-orange-500 lg:text-orange-700'>
            ...
            lg:col-span-4 lg:col-start-3 lg:row-start-12'>
				<ButtonExpert color={'orange'} label='Quero atendimento personalizado' animation='animate-pulse' />
			</div>

			{!isMobile && (
				<>
					<Image className='h-[40.7rem] lg:col-span-6 lg:col-start-7' alt='background_image' src={HeaderPartial} />
				</>
			)}
		</header>
	);
