	...
	return (
		<section className='flex flex-col justify-center items-center p-10 gap-10 w-full'>
            ...
            lg:text-left lg:text-lg'>
							...
							<li className='flex flex-row gap-4 items-center h-[2rem]'>
								<Image sizes='' alt='Tick' src={Tick} />
								<span>Já atendemos mais de 12.000 usuários em milhares de{!isMobile && <br />} projetos implantados.</span>
							</li>

							<li className='flex flex-row gap-4 items-center h-[2rem]'>
								<Image sizes='' alt='Tick' src={Tick} />
								<span>Somos a empresa mais tradicional do mercado, com mais {!isMobile && <br />} de 30 anos de experiência.</span>
							</li>
						</ul>
					</div>
					<div>
